...
class ConvertedViewsTest extends TestCase
{
    ...
    private const NOT_YET_CONVERTED = [
        ...
        'poker/registrants/index.blade.php',
        'poker/results/create.blade.php',
        'poker/results/edit.blade.php',
        'poker/results/index.blade.php',
        'poker/seasons/create.blade.php',
        'poker/seasons/edit.blade.php',
        ...
        'poker/venues/create.blade.php',
        'poker/venues/edit.blade.php',
        'poker/venues/index.blade.php',
        'poker/venues/show.blade.php',
