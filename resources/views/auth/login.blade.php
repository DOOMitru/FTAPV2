                    ...
                    <div class="bg-white dark:bg-gray-800 py-10 px-6 shadow-xl sm:rounded-lg sm:px-12">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                            ...
                            <div class="flex items-center justify-between">
                                <label for="remember_me" class="inline-flex items-center">
                                    <input id="remember_me" type="checkbox" class="rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
                            ...
                            <div class="pt-2">
                                <x-primary-button class="w-full justify-center py-3 bg-indigo-600 hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 ring-indigo-500">
                                    {{ __('Sign in') }}
                                </x-primary-button>
                            </div>
                        </form>
