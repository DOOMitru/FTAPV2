<x-public-layout>
    <div class="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Our Mission Section -->
            <div class="flex flex-col gap-12 md:flex-row md:items-start mb-20">
                <div class="md:w-1/3 flex justify-center md:justify-start">
                    <img class="w-full h-auto max-w-[220px] md:w-auto md:max-w-none md:max-h-[320px] lg:max-h-[360px] object-contain transition-transform duration-500 hover:scale-105" src="{{ asset('images/hero_logo.png') }}" alt="First to Act Poker League">
                </div>
                <div class="md:w-2/3">
                    <x-section-badge type="mission" class="mb-4" />
                    <h1 class="text-3xl sm:text-4xl font-bold mb-8 text-gray-900 dark:text-white">Our Mission</h1>
                    <div class="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
                        <p class="text-xl leading-relaxed">
                            <strong>First to Act Poker</strong> is dedicated to providing high-quality, free-to-play poker events for the social player in Regina. We believe that the excitement of Texas Hold'em should be accessible to everyone in a fun, safe, and competitive environment.
                        </p>
                        <p class="mt-6 text-lg">
                            We run weekly events where players can sharpen their skills, socialize with the local community, and accumulate points that lead toward exclusive special events and rewards.
                        </p>
                        <p class="mt-6 text-lg">
                            Our league creates a win-win ecosystem: host venues are introduced to new customers, and local businesses gain a platform for focused exposure. We also proudly host charity tournaments, ensuring that our love for the game also helps support meaningful causes.
                        </p>
                    </div>
                </div>
            </div>
