{{-- Both icons ship in the DOM; CSS shows exactly one based on [data-theme],
     which the theme script always stamps before first paint. Each icon
     carries its own visually-hidden label describing what the click will
     DO, not the current state, so there is no aria-pressed to maintain. --}}
