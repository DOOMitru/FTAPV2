                    ...
                    <div class="space-y-6">
                        <div class="space-y-4">
                            <div class="flex flex-wrap gap-2 text-[10px] font-bold uppercase tracking-widest">
                                <span class="px-2 py-1 bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center" title="Start Time">
                                ...
                                <span class="px-2 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-lg border border-indigo-200 dark:border-indigo-800 flex items-center" title="Registration Deadline">
